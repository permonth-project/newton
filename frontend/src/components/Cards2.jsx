...
const Cards = () => {
  return (
    <div className='max-w-[1240px] group mx-auto  px-2 sm:px-0 bg-black/0   mt-4 sm:py-4 py-8 rounded-xl' id='feature'>
        ...
        <div className=' mx-auto md:grid grid-cols-3 gap-8 my-4 group-hover text-center'>
            ...
            <p className="font-medium text-black/60 mt-8 text-sm">
