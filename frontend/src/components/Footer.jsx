...
const Footer = () => (
    <div className='max-w-[1240px] sm:mb-8 mx-auto py-16 px-16 grid md:grid-cols-3 gap-8  bg-[#fff2f1] sm:rounded-3xl'>
        <div>
            ...
            <button className='bg-[#93123f] text-white rounded-md font-medium w-[200px] ml-4 my-6 px-6 py-2'>Subscribe</button>
